...
const FORBIDDEN = ["evidence-runner", "farm-service", "source-", "destination", "platform-adapters", "official-api", "ocr", "scheduler", "http-server", "mcp-server", "cli", "registration", "critique-runner", "client-state-destinations", "browser-obstructions", "evidence-run-input", "html-preview"];
