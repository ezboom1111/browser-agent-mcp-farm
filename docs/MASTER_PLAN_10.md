...
- ⬜ next: P4 recipe canary + coverage-report matrix; P6 Biome lint gate, evidence-runner
  split, research quarantine, 80% coverage; P5 agent-to-agent .evb exchange example;
  P7 publish metadata + tarball test + conformance suite.
